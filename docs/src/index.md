...
and VTK. The package only writes files; it aims to feel familiar to
...
!!! note "Reader support"
    ...
    VTKHDF specification (2.7/2.8) and require a VTK build new enough to read
    them. All other types round-trip against VTK 9.6's `vtkHDFReader` in this
