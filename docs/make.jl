...
open(joinpath(@__DIR__, "src", "examples", "overview.md"), "w") do io
    ...
    println(io, "These examples focus on complete, visualization-ready datasets. If this is your first VTKHDF file, start with the [Manual](@ref manual) and its smaller examples. Then return here for the dataset type you need.\n")
    println(io, "```@raw html")
